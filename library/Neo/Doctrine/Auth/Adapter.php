 ...
 * @subpackage Doctrine_Auth_Adapter
 * @copyright  Copyright (c) 2005-2010 Zend Technologies USA Inc. (http://www.zend.com)
 * @license    http://framework.zend.com/license/new-bsd     New BSD License
 */
class Neo_Doctrine_Auth_Adapter implements Zend_Auth_Adapter_Interface
{
    /**
     * Database Connection
     *
     ...
     * @return Neo_Doctrine_Auth_Adapter Provides a fluent interface
     */
